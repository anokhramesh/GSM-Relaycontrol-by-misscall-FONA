...
#include "Adafruit_FONA.h"//Install Sdafruit fona library
 
#define FONA_RX            2// connect RXD pin to Arduino pin 2
#define FONA_TX            3// connect TXD pin to Arduino pin 3
